...
labour_force_age = 'D:/Data Science Projects/Malaysia Statistics/Excel Files/04.Labour force by age group.xlsx'
labour_force_ethnic = 'D:/Data Science Projects/Malaysia Statistics/Excel Files/05.Labour force by ethnic group.xlsx'
labour_force_edu = 'D:/Data Science Projects/Malaysia Statistics/Excel Files/06.Labour force by educational attainment.xlsx'
labour_force_cert = 'D:/Data Science Projects/Malaysia Statistics/Excel Files/07.Labour force by highest certificate obtained.xls'
labour_force_marital = 'D:/Data Science Projects/Malaysia Statistics/Excel Files/08.Labour force by marital status.xls'
employed_age = 'D:/Data Science Projects/Malaysia Statistics/Excel Files/09.Employed persons by age group.xls'
employed_ethnic = 'D:/Data Science Projects/Malaysia Statistics/Excel Files/10.Employed persons by ethnic group.xls'
employed_edu = 'D:/Data Science Projects/Malaysia Statistics/Excel Files/14.Employed persons by educational attainment.xls'
employed_cert = 'D:/Data Science Projects/Malaysia Statistics/Excel Files/15.Employed persons by highest certificate obtained.xls'
employed_marital = 'D:/Data Science Projects/Malaysia Statistics/Excel Files/16.Employed persons by marital status.xls'
...
total_unemployment_breakdown_by_marital = px.pie(pd.melt(df_unemployed_marital.loc[-1:, df_unemployed_marital.columns != 'Total'].iloc[-1:,:]),
                                        title='Total Unemployment Breakdown by Marital Status 2020',
                                        values='value',
                                        names='variable',
                                        width=1000
                                        )
...
total_unemployment_by_marital = px.bar(pd.melt(df_unemployed_marital.loc[-1:, df_unemployed_marital.columns != 'Total'].iloc[-1:,:]),
                                        title='Total of Unemployment by Marital Status in 2020',
                                        y='value',
                                        x='variable',
                                        labels={'value' : 'Total of Unemployment (thousands)', 'variable' : 'Marital Status'}, 
                                        color='variable',
                                        text_auto=True,
                                        width=1000
                                        )
...
def app():
    ...
    st.plotly_chart(total_unemployment_breakdown_by_marital)

    st.plotly_chart(total_unemployment_by_marital)